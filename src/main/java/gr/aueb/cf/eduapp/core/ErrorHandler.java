...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleEntityNotFoundException(EntityNotFoundException e) {
        ...
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)                                              // Http code - 404 Not found.
    ...
    public ResponseEntity<ErrorResponseDTO> handleEntityInvalidArgumentException(EntityInvalidArgumentException e) {
        ...
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)                                          // Http code - 400 Bad Request.
                .body(new ErrorResponseDTO(e.getCode(), e.getMessage()));              // Business code
    }
    ...
    public ResponseEntity<ErrorResponseDTO> handleAuthenticationException(AuthenticationException e,
        ...
        String errorCode = switch (e) {
            ...
            case AccountExpiredException ex -> "ACCOUNT _EXPIRED";
