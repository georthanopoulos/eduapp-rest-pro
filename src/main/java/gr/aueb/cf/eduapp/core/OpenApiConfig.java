...
@SecurityScheme(
        ...
        bearerFormat = "JWT",
        scheme = "bearer"                // way of authentication
)
public class OpenApiConfig {

    /*
        Provides all the metadata for swagger UI header section
     */
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("""
                                REST API managing Coding Factory teachers' registry.
